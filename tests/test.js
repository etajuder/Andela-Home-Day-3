var oneToTwenty = require('../app/index.js').oneToTwenty;
var twoToForty = require('../app/index.js').twoToForty;
var tenToOneThousand = require('../app/index.js').tenToThousand;
Array.prototype.toTwenty = oneToTwenty;
Array.prototype.toForty = twoToForty;
Array.prototype.toOneThousand = tenToOneThousand;
